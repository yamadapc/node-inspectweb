...
(function(jQuery) {
  ...
  JSONFormatter = (function() {
    ...
    JSONFormatter.prototype.arrayToHTML = function(array, level) {
      ...
      if (hasContents) {
        collapsible = level === 0 ? '' : ' jsonview-collapsible';
  ...
  Collapser = (function() {
    ...
    Collapser.collapseTarget = function(collapser) {
      var target, targets;
      targets = collapser.parentNode.getElementsByClassName('jsonview-collapsible');
      if (!targets.length) {
        return;
      }
  ...
  return $.fn.JSONView = function() {
    ...
    if (JSONView[args[0]] != null) {
      ...
      return this.each(function() {
        ...
        if (args[1] != null) {
          level = args[1];
          return $this.find(".jsonview .jsonview-collapsible.level" + level).siblings('.collapser').each(function() {
            return JSONView[method](this);
          });
        } else {
          return $this.find('.jsonview > ul > li .jsonview-collapsible').siblings('.collapser').each(function() {
            return JSONView[method](this);
          });
        }
      });
      ...
      return this.each(function() {
        ...
        $this = $(this);
        $this.html(outputDoc);
        items = $this[0].getElementsByClassName('jsonview-collapsible');
        _results = [];
